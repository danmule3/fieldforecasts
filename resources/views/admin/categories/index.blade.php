<x-layouts.admin :title="'Categories'">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.categories.create') }}"><x-button>+ Add category</x-button></a>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl ring-1 ring-slate-900/5 dark:ring-white/10 overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-slate-50 dark:bg-slate-800 text-left text-xs text-slate-500 dark:text-slate-400">
                <tr><th class="px-4 py-3">Name</th><th class="px-4 py-3"></th></tr>
            </thead>
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            <a href="{{ route('admin.categories.edit', $category) }}" class="text-indigo-600 dark:text-indigo-400">Edit</a>
